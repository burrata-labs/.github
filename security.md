...
Projects governed by burrata sometimes do unsafe things by design (such as a
embed third-party Javascript that executes arbitrary code).
...
Security issues can be reported by sending an email to `security@burrata.xyx`,
which will go to all [**burrata engineering team**][core] members.
...
**burrata** supports safe harbor for security researchers who:
...
[burrata]: https://github.com/burrata-labs

[core]: https://github.com/orgs/burrata-labs/people